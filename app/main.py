...
async def predict_result(task_id):
    ...
    number_commits, commits_info_users, commits_info_dates, pull_requests_closed, pull_requests_opened, dates_dict = task.get()
    return {"task_id": task_id, "status": "Success", "number_commits": number_commits, "commits_info_users":commits_info_users, "commits_info_dates":commits_info_dates,
            "pull_requests_closed":pull_requests_closed, "pull_requests_opened":pull_requests_opened,
            "issues":dates_dict}